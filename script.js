            ...
            if (screenResult.innerHTML != errorMessage && screenResult.innerHTML != "Infinity"){  
                ...
                if (valeur == "DEL"){
                    if (arrayNombre.length > 1){
                        ...
                        if (screenResult.innerHTML.length == 0){
                            Reset();
                        }
                    }
                } 
                ...
                if (operators[valeur]){
                    ...
                    if (arrayNombre.length <= 1){
                        ...
                        console.log("array " +arrayNombre)
                        console.log("array length " +arrayNombre.length)
                    }
                    else if (arrayNombre.length > 1){
                        let arrayPaire = [...arrayNombre]
                        console.log(arrayPaire)
                ...
                if (valeur == "="){
                    ...
                    console.log("array  starrt" + arrayNombre)
                    if (nombre != ""){
                        arrayNombre.push(nombre)
                        nombre = "";
                    }
                    console.log("array after number" + arrayNombre)
                        let arrayPaire = [...arrayNombre]
                        console.log(arrayPaire)
                        arrayNombre.length = 0;
                        Calcul([...arrayPaire])
